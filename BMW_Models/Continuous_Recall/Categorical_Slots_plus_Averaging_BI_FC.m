%% Categorical Slots-plus-Averaging (Between-Item, Free Category)
%
...
function Output=Categorical_Slots_plus_Averaging_BI_FC(param, Data, Input)
...
Ncat=Data.Ncat; % Number of categories
Lc=ceil(param(Nparam+1:Nparam+Ncat));
Nparam=Nparam+Ncat;
...
categories=Data.category_range(cat_ind0)';
% Data=Categorization_BMW(Data);
