%% Fixed-Capacity (Full-Display)
%
% LLH function of the Fixed-Capacity model (Full-Display)
% ------------
% ## Theory ##
...
% Note that it is for full-display change detection paradigm only, any kind 
...
% ## Reference ##
% H. Pashler, 1988, Perception & Psychophysics
...
function LLH=Fixed_Capacity_Full_Display(param, input)
