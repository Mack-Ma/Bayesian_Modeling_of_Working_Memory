...
List_Name={'Item_Limit','Standard_Mixture','Equal_Precision','Slots_plus_Averaging',...
    'Variable_Precision','Variable_Precision_with_Capacity','Categorical_Standard_Mixture_BV' ,'Categorical_Slots_plus_Averaging_BV',...
...
List_Name0={'Item Limit', 'Standard Mixture', 'Equal Precision', 'Slots-plus-Averaging',...
    'Variable Precision', 'Variable Precision with Capacity', 'Categorical Standard Mixture (Between-Variant)' ,'Categorical Slots-plus-Averaging (Between-Variant)',...
